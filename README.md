...
```
X shall either `xiao_headers` (sx1262 via dupont cables), `xiao_connector` (using the special connector on the xiao board: https://www.antratek.nl/xiao-esp32s3-for-meshtastic-lora), `heltec_v3`, `t_beam_v1_2`, `lilygo_t3` or `t_beam_supreme`.
